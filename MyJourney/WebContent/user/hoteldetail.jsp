...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function vote(uid,hid,type,isRated){
				if(uid==null){
					alert('您还未登陆!');
					location.href="index";
				}else{
					if(isRated=='1'){
						...
						$.ajax({
							type:'post',
							url:'uservote.action',
							data:{hid:hid,voteType:'hotel',voteFoD:type},
							dataType:"json",  
							success: function(data){
								...
								location.href="/MyJourney/user/userviewHotel?hid="+hid+"&uid="+uid;
							},
	...
	<body>
		...
		<nav>
			<ul>
				...
				<li class='selected'><a href="Hotels">酒店</a></li>
		...
		<div id="containAll">
			<div id="text_div"><span><a href='Hotels'>返回酒店列表</a></span></div>
			<div class="seperator"></div>
			<!-- menu-->
			<div id="cter">
				<div id="j_contents">
					<div id='title_div'>
						<span class='x_title'><%out.print(hotel.getName());%></span>
					...
					<div id='info_div'>
						<div id='upper'>
							<span>所在城市:</span>
							<span>
							<% out.print(hotel.getCity().getName()); %>
							</span>
							&nbsp;&nbsp;&nbsp;
							<span>地址:</span>
							<span>
							...
							<div class='likeNdis' align='center'>
								<img class='thumb' src='../images/sdd09/up.jpg' onclick='vote(<%out.print(uid);%>,<% out.print(hotel.getId());%>,1,<% out.print(isRated);%>)'><span class='voteUp'><% out.print(hotel.getFavor());%></span>&nbsp;&nbsp;&nbsp;
								<img class='thumb' src='../images/sdd09/down.jpg' onclick='vote(<%out.print(uid);%>,<% out.print(hotel.getId());%>,0,<% out.print(isRated);%>)'><span class='voteDown'><% out.print(hotel.getDislike());%></span>
							</div>
						</div>
						<div id='downer'>
							...
							<div id='downer_i'>
								<% 
									if(hotel.getComments().size()==0){
										...
										out.print("用户评价:");
										for(int k=0;k<hotel.getComments().size();k++){
											out.print("<div class='cdi'>");
											out.print("<span>用户&nbsp;</span>");
											out.print("<span>"+hotel.getComments().get(k).getUser().getAccount()+"</span>&nbsp;");
											out.print("<span><B><I>说道</I></B></span>&nbsp;");
											out.print("<div class='realc'>");
											out.print(hotel.getComments().get(k).getContext());
											out.print("</div>");
											out.print("</div>");
										}
									}
